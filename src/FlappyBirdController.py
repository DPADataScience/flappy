...
def main():
    ...
    environment = Environment(app, FPS=30, stacked_frames=4) #the reward functie doet het nog niet helemaal goed! dedecteert onterechte flappy is dood statements
